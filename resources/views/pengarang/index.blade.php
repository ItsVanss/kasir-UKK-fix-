                        ...
                        <table class="table table-striped" id="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$item->nama}}</td>
                                    <td>
                                        <form action="/pengarang/{{$item->id}}" id="delete-form">
                                            {{-- <a href="/pengarang/{{$item->id}}/show"
                                                class="btn btn-sm btn-outline-info"><i class="fa fa-eye"></i> Detail</a> --}}
                                            <a href="/pengarang/{{$item->id}}/edit"
    ...
    function confirmDelete(button) {
        ...
        .then((willDelete) => {
            if (willDelete) {
                ...
                form.action = '/pengarang/' + id; // Ubah aksi form sesuai dengan ID yang sesuai
                form.submit();
            }
        });
    }
